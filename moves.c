...
t_move getMoveType(const char *moove) {
    if (strcmp(moove, "F_10") == 0) return F_10;
    if (strcmp(moove, "F_20") == 0) return F_20;
    if (strcmp(moove, "F_30") == 0) return F_30;
    if (strcmp(moove, "B_10") == 0) return B_10;
    if (strcmp(moove, "T_LEFT") == 0) return T_LEFT;
    if (strcmp(moove, "T_RIGHT") == 0) return T_RIGHT;
    if (strcmp(moove, "U_TURN") == 0) return U_TURN;


    return -1; // Indique un mouvement invalide
}
